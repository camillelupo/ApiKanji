...
def get_kanjidic2_data():
    # Load the XML file
    tree = ET.parse('application/kanjidic2.xml')
    ...
    if reading_meaning is not None:
        ...
        for rmgroup in rmgroups:
            ...
            for meaning in meanings:
                ...
                if m_lang is None or m_lang == "fr":
...
for character, entry in kanjidic2_json.items():
    ...
    with open("../json/kanjidic.json", "wt", encoding="utf-8") as fp:
        json.dump(kanjidic2_json, fp, ensure_ascii=False, indent=4)
